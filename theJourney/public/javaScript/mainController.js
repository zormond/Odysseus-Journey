var journeyApp = angular.module('theJourney', []);

journeyApp.controller('journeyController', function($scope)
{
    var myShip = $("#ship");
    var counter = 0;
    var endPointX = 0;
    ...
    $scope.moveShip = function(){
        ...
        switch(counter){
            case 0:
                endPointX = wW * .60;
                endPointY = wH * .65;
                angle2 = 40;//Set the first parameters for the animation.s
                //Animate with a call back to animation again with new parameters.
