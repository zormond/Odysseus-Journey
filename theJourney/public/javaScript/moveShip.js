$(document).ready(function(){
    ...
    //Help used to create html for that will be presented in the swal. Data will be retrieved from the database.
    ...
    //Standard swal at each stop in the journey
    ...
    //Helper function to create the path that the ship travels.
 ...
 //This is the start of all the animations.    
swal({
